...
export class DistributedLoadBalancedServiceStack extends Stack {
  ...
  constructor(scope: Construct, id: string, props: DistributedLoadBalancedServiceStackProps) {
    ...
    const certificateArnDistribution= new SSMParameterReader(this, `${id}-paramReaderCertArnDist`, {
      parameterName: deriveParameter(props, `${removeNonTextChars(props.domainDistribution)}/certificateArn`),
      region: DNS_RESOURCES_REGION
    }).getParameterValue();
    ...
    const hostZoneIdDistribution= new SSMParameterReader(this, `${id}-paramReaderHzIdDist`, {
      parameterName: deriveParameter(props, `${removeNonTextChars(props.domainDistribution)}/hostedZoneId`),
      region: DNS_RESOURCES_REGION
    }).getParameterValue();
